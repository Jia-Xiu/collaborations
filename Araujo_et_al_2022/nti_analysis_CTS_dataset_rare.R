# Description: NTI, beta-NTI analysis for the CTS dataset
# Date: 22-06-2022
...
cat("calculate NTI for the rare biosphere")
...
write.csv(beta.mntd.weighted, "betaMNTD_weighted_rare.csv", quote=F);
...
weighted.bNTI;
write.csv(weighted.bNTI, "betaNTI_weighted_rare.csv", quote=F)
...
write.csv(ses_mntd, "SES_MNTD_rare.csv", row.names=T, quote=F)
